...
\begin{enumerate}[leftmargin=2em, label={[\arabic{*}]}]
	\item Erwin Kreyszig, \textit{Introductory Functional Analysis with Applications}, John Wiley \& Sons, 1978.
	
	\item Walter Rudin, \textit{Principles of Mathematical Analysis}, 3rd Edition, McGraw-Hill, 1976.
\end{enumerate}
}
