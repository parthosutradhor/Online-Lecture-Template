...
\newcommand*{\Chapter}{Gaps in the Rational Numbers}
\newcommand*{\Topics}{Supremum and Infimum}
...
\begin{document}
    ...
    \begin{heading}
		There are holes or gaps in $\mathbb{Q}$
	\end{heading}

    \vspace{10pt}

    \begin{problem}
        Show that there is no rational number $x$ such that $x^2 = 2$.
    \end{problem}
    ...
    \begin{definition}[Upper Bound]
        Let $S \subseteq \mathbb{Q}$.  
        An element $u \in \mathbb{Q}$ is called an \textbf{upper bound} of $S$ if
        \[
        x \leq u \quad \text{for all } x \in S.
        \]
        If such an element exists, we say that $S$ is \emph{bounded above} in $\mathbb{Q}$.  
    \end{definition}
    \vfill
    \begin{definition}[Lower Bound]
        Let $S \subseteq \mathbb{Q}$.  
        An element $l \in \mathbb{Q}$ is called a \textbf{lower bound} of $S$ if
        \[
        x \leq l \quad \text{for all } x \in S.
        \]
        If such an element exists, we say that $S$ is \emph{bounded below} in $\mathbb{Q}$.
    \end{definition}
    ...
    \begin{definition}[Least Upper Bound (Supremum)]
        Let $S \subseteq \mathbb{Q}$.  
        An element $s \in \mathbb{Q}$ is called the \textbf{least upper bound} or the \textbf{supremum} of $S$ in $\mathbb{Q}$ if
        \begin{enumerate}
            \item $s$ is an upper bound of $S$, and
            \item for every upper bound $u$ of $S$, we have $s \leq u$.
        \end{enumerate}
    \end{definition}
    ...
    \begin{definition}[Greatest Lower Bound (Infimum)]
        Let $S \subseteq \mathbb{Q}$.  
        An element $i \in \mathbb{Q}$ is called the \textbf{greatest lower bound} or the \textbf{infimum} of $S$ in $\mathbb{Q}$ if
        \begin{enumerate}
            \item $i$ is a lower bound of $S$, and
            \item for every lower bound $l$ of $S$, we have $i \geq l$.
        \end{enumerate}
    \end{definition}
    ...
    \begin{problem}
    Find the \textbf{supremum} and \textbf{infimum} of each of the following set:
    \[
    ...
    Find the \textbf{supremum} and \textbf{infimum} of each of the following set:
    \[
    \{\, \tfrac{n}{m} : m,n \in \mathbb{N} \text{ with } m+n \le 10 \,\}
    \]
    \end{problem}
    \clearpage
    \begin{problem}
    ...
    \begin{theorem}[Properties of Supremum]
    Let $A \subseteq \mathbb{Q}$ be a nonempty set that is bounded above.  
    Denote $\sup A$ by the least upper bound of $A$.  
    Then the following properties hold:
    \begin{enumerate}[label=(\alph*)]

    \item $u$ is an upper bound for \(A \quad \Longleftrightarrow \quad \sup A \le u.\)

    \item If $u < \sup A$, then  
    $\exists\, a \in A$ such that $u < a \le \sup A.$

    \item If $A \subseteq B$, then $\sup A \le \sup B$.

    \item Let $A+B = \{\, a + b : a \in A,\, b \in B \,\}$.  
    Then
    \[
    \sup(A+B) = \sup A + \sup B.
    \]

    \item Let $A \cdot B = \{\, a b : a \in A,\, b \in B \,\}$  
    and suppose $A,B \subseteq \mathbb{R}_+$.  
    Then
    \[
    ...
    \begin{theorem}
    Assume $s \in \mathbb{Q}$ is an upper bound for a set $A \subseteq \mathbb{Q}$.  
    Then $s = \sup A$ if and only if, for every $\varepsilon > 0$,  
    there exists an element $a \in A$ such that
    \[
    s - \varepsilon < a.
    \]
    \end{theorem}
    ...
    \begin{theorem}[Properties of Infimum]
    Let $A \subseteq \mathbb{Q}$ be a nonempty set that is bounded below.  
    Denote $\inf A$ by the greatest lower bound of $A$.  
    Then the following properties hold:
    \begin{enumerate}[label=(\alph*)]
    \item $l$ is a lower bound for \(A \quad \Longleftrightarrow \quad \inf A \ge l.\)
    \item If $l > \inf A$, then
    \item If $A \subseteq B$, then $\inf A \ge \inf B$.
    \item Let $A+B = \{\, a + b : a \in A,\, b \in B \,\}$.  
    Then
    \[
    \inf(A+B) = \inf A + \inf B.
    ...
    \vfill
    \begin{theorem}
    Assume $s \in \mathbb{Q}$ is an least lower bound for a set $A \subseteq \mathbb{Q}$.  
    Then $s = \inf A$ if and only if, for every $\varepsilon > 0$,
    there exists an element $a \in A$ such that
    \[
    s + \varepsilon > a.
    \]
    ...
    \begin{heading}
        Not every bounded above subset of \(\mathbb{Q}\) has a supremum in \(\mathbb{Q}\)
    \end{heading}
    \vspace{10pt}
    \begin{problem}
        Show that the set $A = \{ x \in \mathbb{Q} : x^2 < 2 \}$ is bounded above in $\mathbb{Q}$ but does not have a supremum in $\mathbb{Q}$.     
