...
\newcommand*{\DocDate}{October 19, 2025}
...
\begin{document}
	...
	\begin{heading}
		Density of Rationals and Irrationals in $\mathbb{R}$
	\end{heading}
	...
	\begin{theorem}[Density of Irrationals in $\mathbb{R}$]
		\textit{For every two real numbers $a$ and $b$ with $a < b$, there exists an irrational number $s$ satisfying $a < s < b$.}
	\end{theorem}
	...
	\begin{theorem}[Existence of n-th Roots]
		\textit{For any given real number $x \geq 0$ and any integer $n \in \mathbb{N}$, there exists a unique real number $y \geq 0$ satisfying $y^n = x$.}
	\end{theorem}
