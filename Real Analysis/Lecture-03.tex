...
\begin{document}
    ...
    \begin{definition}[Completeness]
		An ordered field $F$ is said to be \textbf{complete} if every nonempty subset of $F$ that is bounded above has a least upper bound (supremum) in $F$.
    \end{definition}

    \vspace{10pt}

    \begin{problem}[Why $\mathbb{Q}$ is not complete?]
        The set $\{ x \in \mathbb{Q} : x^2 < 2 \}$ is bounded above in $\mathbb{Q}$ but does not have a supremum in $\mathbb{Q}$.     
    \end{problem}
