...
\begin{theorem}
    A set $A \subseteq \mathbb{R}$ is said to be of measure zero if for every $\epsilon > 0$, there exists a countable collection of open intervals $\{U_n\}_{n=1}^{\infty}$ such that $A \subseteq \bigcup_{n=1}^{\infty} U_n$ and $\sum_{n=1}^{\infty} |U_n| < \epsilon$, where $|U_n|$ denotes the length of the interval $U_n$.
\end{theorem}
...
\begin{theorem}[Continuity and Oscillation]
