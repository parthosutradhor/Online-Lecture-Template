...
\definecolor{DefBack}{RGB}{240,248,255}   % very soft azure (background)
\definecolor{DefMain}{RGB}{0,102,224}     % deep academic blue

\definecolor{ThmBack}{RGB}{235,255,238}   % pale mint (background)
\definecolor{ThmMain}{RGB}{0,173,76}      % strong green (not neon)

\definecolor{ProbBack}{RGB}{255,250,240}  % light ivory (background)
\definecolor{ProbMain}{RGB}{204,85,0}     % burnt orange (balanced)

\definecolor{HeadL}{RGB}{25,50,120}       % dark navy
\definecolor{HeadR}{RGB}{50,150,220}      % mid-sky blue
