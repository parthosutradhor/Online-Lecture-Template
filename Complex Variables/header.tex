...
\begin{enumerate}[leftmargin=2em, label={[\arabic{*}]}]
	\item Murray R. Spiegel, \textit{Schaum’s Outline of Complex Variables}, 2nd Edition, McGraw–Hill, 2009.

    \item Dennis G. Zill, \textit{A First Course in Differential Equations with Modeling Applications}, 11th Edition, Cengage, 2018.
\end{enumerate}
}
